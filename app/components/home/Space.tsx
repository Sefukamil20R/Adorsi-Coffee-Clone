      ...
      <Container>
        ...
        <div className="grid items-end gap-10 lg:grid-cols-[1.08fr_0.92fr]">
          ...
          <div className="max-w-[600px] pb-3">
            ...
            <h2 className="font-heading text-[64px] leading-[1.06] text-white">
              A room shaped
              <br />
          ...
          <div className="flex justify-end pb-5">
            <p className="max-w-[510px] text-[17px] leading-8 text-[#C7CFD8]">
        ...
        <div className="mt-14 flex justify-center">
          <div className="grid w-full max-w-[1200px] grid-cols-2 gap-5">
            <div className="rounded-[28px] border border-[var(--gold)]/30 p-[1px]">
              <Image
                src="/space/space1.webp"
                alt="Adorsi Space 1"
                width={720}
                height={700}
                className="h-[420px] w-full rounded-[27px] object-cover"
              />
            </div>
